...
public Map<String, Integer>[] var = new Map[1000];
	public int[] coe = new int[1000];
	public int num;
	public int temp;
	...
	public final void simplify(String[] op) {
	...
	public final void derivative(String dx) {
		boolean flag = false;
		for (int i = 0; i < num; i++) {
	...
	public final boolean set(String st) {
